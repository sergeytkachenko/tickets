<?php
	...
	$mcFileManagerConfig['general.tools'] = "createdir,createdoc,refresh,upload,zip,unzip,insert,view,download,rename,props,selectall,unselectall,copy,cut,paste,delete,imagemanager";
	...
	$mcFileManagerConfig['general.plugins'] = "History"; // comma seperated
	...
	$mcFileManagerConfig['preview.urlprefix'] = ($_SERVER['SERVER_PORT'] == SERVER_SECURE_PORT ? 'https' : 'http') . "://$_SERVER[HTTP_HOST]/"; // domain name
	...
	$mcFileManagerConfig['filesystem.rootpath'] = "../../../../attach"; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,htm,html,pdf,txt,zip,doc,docx,ppt,pptx,xls,xlsx,mp4";
	...
	// Upload options
	$mcFileManagerConfig['upload.maxsize'] = "200MB";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,bmp,htm,html,pdf,txt,zip,doc,docx,ppt,pptx,xls,xlsx,mp4";
	...
	$mcFileManagerConfig['download.extensions'] = "gif,jpg,jpeg,png,bmp,htm,html,pdf,txt,zip,doc,docx,ppt,pptx,xls,xlsx,mp4";
	...
	$mcFileManagerConfig['filesystem.allow_override'] = "*";
	$mcFileManagerConfig['filesystem.exclude_file_pattern'] = "/^mc_access$/i";

	//XXX
	$mcFileManagerConfig['filesystem.list_directories'] = true;
