Ext.define('MyDesktop.SaunsManager', {
    ...
    onDeleteClick: function(id){
        ...
        Ext.MessageBox.confirm('Confirm', 'Delete this item?', function(btn) {
            ...
            Ext.Ajax.request({
                url: '/admin/sauns/delete.json?id=' + id,
                success: function() {
                    self.store.load();
                }
            });
    ...
    createForm : function(id, data){
        ...
        var desktop = this.app.getDesktop();
        var winId = 'sauns-manager-sauns-form-' + id;
