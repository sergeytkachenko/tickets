Ext.define('MyDesktop.HotelsManager', {
    ...
    createWindow : function(){ // открытие списка событий 
        ...
        if(!win) {
            ...
            this.store = Ext.create('Ext.data.Store', {
                ...
                proxy: {
                    type: 'ajax',
                    url: '/admin/hotels/get-list.json',
                    reader: {
                        type: 'json',
                        root: 'data',
    ...
    onDeleteClick: function(id){
        ...
        Ext.MessageBox.confirm('Confirm', 'Delete this item?', function(btn) {
            ...
            Ext.Ajax.request({
                url: '/admin/hotels/delete.json?id=' + id,
                success: function() {
                    self.store.load();
                }
            });
    ...
    createForm : function(id, data){
        ...
        var desktop = this.app.getDesktop();
        var winId = 'hotels-manager-hotels-form-' + id;
