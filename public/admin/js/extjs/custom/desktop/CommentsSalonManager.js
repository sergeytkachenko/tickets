Ext.define('MyDesktop.CommentsSalonManager', {
    extend: 'Ext.ux.desktop.Module',

    id:'comments-salon-manager',
    ...
    createWindow : function(){ 
        ...
        if(!win) {
            ...
            this.store = Ext.create('Ext.data.Store', {
                ...
                proxy: {
                    type: 'ajax',
                    url: '/admin/comments-salon/get-list.json',
                    reader: {
                        type: 'json',
                        root: 'data',
            ...
            this.grid = Ext.create('Ext.grid.Panel', {
                ...
                columns:[{
                    ...
                    renderer: function(value){
                        var myURL = '';
                        if(value !== ''){
                            myURL = '<a href="/salon/view/' + value + '-url.html" target="_blank">см. салон('+value+')</a>';
                        }
                        return myURL;
                    }
                }]
    ...
    onDeleteClick: function(id){
        ...
        Ext.MessageBox.confirm('Confirm', 'Удалить?', function(btn) {
            ...
            Ext.Ajax.request({
                url: '/admin/comments-salon/remove.json?id=' + id,
                success: function() {
                    self.store.load();
                }
            });
    ...
    createForm : function(id, data){
        ...
        var desktop = this.app.getDesktop();
        var winId = 'comments-salon-manager-comments-salon-form-' + id;
        ...
        if(!win){
                ...
                buttons: [{
                    ...
                    handler: function(){
                        this.up('form').getForm().submit({
                            ...
                            url: '/admin/comments-salon/save.json',
            ...
            if (id != 'new') {
                var f = form.getForm().load({
                    url: '/admin/comments-salon/get-one.json',
                    params : {
                        'id' : id
                    }
                });
