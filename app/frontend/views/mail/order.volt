...
<div style="width: 90%;margin: auto;background: #FFFFFF;padding:2%;border:solid 0.1em #CBCBCB;border-radius: 0.5em;">
    <a href="http://circus.org.ua"><img style="max-width: 100%; height: auto; margin-left: 45%;" src="http://circus.org.ua/img/logo_png.png"></a>
    ...
    <h3 style="font-family:sans-serif, arial;font-weight:200;font-size:1em;text-align:left;color:#464646; line-height:1em;">
        Отримати квитки можна <b>без черги у окремій "Інтернет касі"</b>, безпосередньо перед початком вистави на яку було придбано квитки .</h3>
    ...
    <h3 style="font-family:sans-serif, arial;font-weight:200;font-size:1em;text-align:left;color:#464646;line-height:1em;">Видача квитків <b>починається за годину до початку вистави і продовжується до самого початку вистави</b>.</h3>
