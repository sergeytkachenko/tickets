    ...
    <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-left">
            <li style="margin-right: 40px;">
                <a class="navbar-brand" href="/"><img src="http://circus.org.ua/img/logo_transparent.png" alt="Прапор України" style="width:100%; height: auto; max-width: 40px; padding: 2px 0; box-sizing: border-box;"></a>
            </li>
