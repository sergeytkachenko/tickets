...
<!-- Body BEGIN -->
<body>
<?php echo $this->partial('partials/first-header'); ?>
<?php echo $this->partial('partials/pre-header'); ?>
<?php echo $this->partial('partials/menu'); ?>
<?php echo $this->partial('partials/slider'); ?>
<div class="main">
    <div class="container">
        <?php echo $this->partial('partials/breadcrumb'); ?>
        <!-- BEGIN SIDEBAR & CONTENT -->
        <div class="row margin-bottom-40">
            <?php echo $this->partial('partials/left-menu'); ?>
            <!-- BEGIN CONTENT -->
            <div class="col-md-7 col-sm-5">
                <?php echo $this->getContent(); ?>
            </div>
            <!-- END CONTENT -->
            <?php echo $this->partial('partials/right-menu'); ?>
        </div>
        <!-- END SIDEBAR & CONTENT -->
    </div>
</div>
